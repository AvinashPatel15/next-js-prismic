...
import { FeaturesSliceDefaultItem, Simplify } from "../../../prismicio-types";
...
type FeatureItem = Simplify<FeaturesSliceDefaultItem>;
  ...
  return (
    ...
    >
      ...
      <div className=" grid sm:grid-cols-2 lg:grid-cols-4 max-w-5xl gap-x-8 gap-y-12 mx-auto sm:place-items-start place-items-center">
        {slice.items.map((item: FeatureItem, index: number) => (
          <div
            key={index}
